...
def run_ppo(config) -> None:
    if not ray.is_initialized():
        ...
        ray.init(
            ...
            "VLLM_ALLOW_RUNTIME_LORA_UPDATING": "true", "RAY_DEBUG":"0",
            "HF_HOME":'/mnt/raid/data/shuohe',
            "CUDA_VISIBLE_DEVICES":'4,5',
            "WANDB_API_KEY":"1040e260ff36dabb6acaaa83f7a7e4c661412cae",
            "WANDB_DIR":"/mnt/raid/data/shuohe/checkpoints"}},
